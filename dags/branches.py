...
def branch_dag():
    ...
    # @task.branch must return the task_id of the downstream task to run.
    # By default, task_id = function name (e.g. 'load_task', 'no_load_task').
    @task.branch 
    ...
    # decider_task (branch) evaluates a condition and returns the task_id of ONE
    # downstream task to run; the other branch is automatically skipped.
